...
# > import reversion
# > reversion.__file__
# '/path/to/env/lib/python3.11/site-packages/reversion/__init__.py'
#
...
sudo python3.11 -m pip install "virtualenv>=1.10"

python3.11 -m virtualenv "$VENVDIR" --always-copy
