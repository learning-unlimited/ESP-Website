...
var QueryBuilder = React.createClass({
  ...
  allFilters: function () {
    return _.defaults(this.props.spec.filters, _.zipObject(_.map(booleanFilters, 'name'), booleanFilters));
  },
  render: function () {
    return /*#__PURE__*/React.createElement("div", {
      className: "query-builder"
    }, "Find ", this.props.spec.englishName, "\u2026", /*#__PURE__*/React.createElement(QueryNode, {
      ref: "queryNode",
      ...
      onClick: this.submit,
      className: "qb-input btn btn-primary"
    }, /*#__PURE__*/React.createElement("span", {
      className: "glyphicon glyphicon-search",
      "aria-hidden": "true"
    }), "\xA0Search"), /*#__PURE__*/React.createElement("button", {
      title: "search and randomize results",
      onClick: this.submitRandom,
      className: "qb-input btn btn-default"
    }, /*#__PURE__*/React.createElement("span", {
      className: "glyphicon glyphicon-random",
      "aria-hidden": "true"
    }), "\xA0Randomize"), /*#__PURE__*/React.createElement("button", {
      title: "jump to manage page for a random result",
      onClick: this.submitLucky,
      className: "qb-input btn btn-default"
    }, /*#__PURE__*/React.createElement("span", {
      className: "glyphicon glyphicon-gift",
      "aria-hidden": "true"
    }), "\xA0I'm Feeling Lucky"));
  }
});
...
var QueryNode = React.createClass({
  ...
  handleToggle: function (event) {
    this.setState({
      negated: event.target.value == "without"
    });
  },
  ...
  render: function () {
    var filterBody = null;
    if (this.state.currentFilterName) {
      if (_.some(booleanFilters, {
        'name': this.state.currentFilterName
      })) {
        filterBody = /*#__PURE__*/React.createElement(BooleanOp, {
          ref: "filter",
        ...
        filterBody = /*#__PURE__*/React.createElement(Filter, {
          ref: "filter",
    ...
    if (this.props.onRemove) {
      removeButton = /*#__PURE__*/React.createElement("button", {
        ...
        className: "glyphicon glyphicon-trash glyphicon-btn-height",
        "aria-hidden": "true"
      }));
    }
    return /*#__PURE__*/React.createElement("div", null, removeButton, /*#__PURE__*/React.createElement("span", {
      className: "error"
    }, this.state.error), /*#__PURE__*/React.createElement(FilterSelector, {
      filterNames: this.props.filterNames,
      filters: this.props.filters,
...
var FilterSelector = React.createClass({
  ...
  render: function () {
    var options = _.map(this.props.filterNames, function (filterName) {
    ...
    return /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement("select", {
      ...
      value: "with"
    }, "with"), /*#__PURE__*/React.createElement("option", {
      value: "without"
    }, "without")), /*#__PURE__*/React.createElement("select", {
...
var Filter = React.createClass({
  ...
  asJSON: function () {
    return _.map(this.props.filter.inputs, function (input, i) {
  ...
  render: function () {
    ...
    var inputs = _.map(this.props.filter.inputs, function (input, i) {
      ...
      return /*#__PURE__*/React.createElement(InputClass, {
        ref: i,
        key: i,
        input: input,
        onSubmit: myOnSubmit
    ...
    return /*#__PURE__*/React.createElement("span", null, inputs);
  }
});
...
var SelectInput = React.createClass({
  ...
  render: function () {
    var options = _.map(this.props.input.options, function (option) {
      return /*#__PURE__*/React.createElement("option", {
        key: option.name,
        value: option.name
      }, option.title);
    ...
    return /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement("span", {
      className: "error"
    }, this.state.error), /*#__PURE__*/React.createElement("select", {
      ref: "select",
      className: "qb-input"
    }, /*#__PURE__*/React.createElement("option", {
      value: null
...
var OptionalInput = React.createClass({
  ...
  render: function () {
    ...
    if (this.state.show) {
      ...
      inner = /*#__PURE__*/React.createElement(InnerClass, {
        ref: "inner",
        input: this.props.input.inner
      });
...
var DatetimeInput = React.createClass({
  ...
  render: function () {
    return /*#__PURE__*/React.createElement("span", null, this.props.input.name, /*#__PURE__*/React.createElement("select", {
      ref: "comparison",
      defaultValue: "before",
      className: "qb-input qb-datetime-select"
    }, /*#__PURE__*/React.createElement("option", null, "before"), /*#__PURE__*/React.createElement("option", null, "after"), /*#__PURE__*/React.createElement("option", null, "exactly")), /*#__PURE__*/React.createElement("input", {
      type: "text",
      className: "datetime-input qb-input",
      ref: "datetime"
    }));
  }
});
...
var TextInput = React.createClass({
  ...
  render: function () {
    return /*#__PURE__*/React.createElement("span", null, this.props.input.name, /*#__PURE__*/React.createElement("input", {
      type: "text",
      ref: "input",
      className: "qb-input",
...
var BooleanOp = React.createClass({
  ...
  getNewChild: function (key) {
    return /*#__PURE__*/React.createElement(QueryNode, {
      key: key,
      filterNames: this.props.filterNames,
      filters: this.props.filters
    });
  ...
  asJSON: function () {
    if (!this.state.childKeys.length) {
      ...
      return _.map(this.state.childKeys, function (key) {
  ...
  fromJSON: function (data) {
    this.setState({
      ...
      // update them.
      childKeys: _.map(data, function () {
        return _.uniqueId();
      })
    }, function () {
      _.map(_.zip(data, this.state.childKeys), function (datumKey) {
  ...
  render: function () {
    var children = _.map(this.state.childKeys, function (key) {
      return /*#__PURE__*/React.createElement("li", {
        key: key
      }, /*#__PURE__*/React.createElement(QueryNode, {
        ref: key,
    ...
    return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("span", {
      className: "error"
    }, this.state.error), /*#__PURE__*/React.createElement("ul", {
      className: "qb-ul"
    }, children, /*#__PURE__*/React.createElement("li", null, /*#__PURE__*/React.createElement("button", {
      onClick: this.handleAdd,
      "aria-label": "Add",
      className: "qb-input btn btn-success"
    }, /*#__PURE__*/React.createElement("span", {
      className: "glyphicon glyphicon-plus glyphicon-btn-height",
      "aria-hidden": "true"
    })))));
  }
});
