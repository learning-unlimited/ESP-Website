...
$j(document).ready(function() {
    ...
    function calculatePosition(mod) {
        ...
        console.log('Position Debug:', mod.link_title || mod.admin_title, {
            start_date: mod.start_date,
            sDate: sDate.toISOString ? sDate.toISOString() : sDate,
            timelineStart: timelineStart.toISOString ? timelineStart.toISOString() : timelineStart,
            leftMs: leftMs,
            totalMs: totalMs,
            leftPct: leftPct
        });
