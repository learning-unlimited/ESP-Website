...
//
//  The schedule fragment is re-rendered by the ajax_schedule view, which used
//  to ship this code to the browser as a "script" value in its JSON response.
//  It now lives here as a static file and is invoked by name through the
//  callback whitelist in ajax_tools.js, so no server-supplied JavaScript is
//  ever executed.
...
//  options.onsite_local: whether this is an onsite (kiosk) session, in which
...
//  Only registered when this page also loaded the Ajax tools; the standalone
//  schedule page uses setup_remove_confirmation() directly.
