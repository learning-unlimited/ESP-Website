...
parser.add_argument(
    "senders_file", help="File with line-separated phone numbers to send from"
)
parser.add_argument(
    "recipients_file", help="File with line-separated recipient phone numbers"
)
...
if not ourNumbers:
    raise ValueError("No senders found")
...
for number in recipients:
    ...
    client.messages.create(body=body, to=number, from_=ourNumbers[numberIndex])
