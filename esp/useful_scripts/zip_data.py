...
user_zipcodes = {}
all_users_query = (
    ESPUser.objects.filter(contactinfo__as_user__isnull=False)
    .select_related("contactinfo_set", "contactinfo_set__address_zip")
    .values_list("id", "contactinfo__address_zip")
    .distinct("contactinfo")
    .order_by("contactinfo")
)
...
zip_rows = [
    [zipcode] + [zipcode_freqs[zipcode] for _, zipcode_freqs in zip_data]
