...
save_survey(
    survey=Survey.objects.get(anchor=splash.anchor, category="learn"),
    filename="E:/projects/lu_sites/esp_mit/spark10_learn_out.txt",
)
save_survey(
    survey=Survey.objects.get(anchor=splash.anchor, category="teach"),
    filename="E:/projects/lu_sites/esp_mit/spark10_teach_out.txt",
)
