...
#   Stuff specific to Granite S.T.I.N.G. Spring 2011
program_id = 3
morning_ids = [2, 3, 5, 6]
lunch_ids = [7, 8]
afternoon_ids = [9, 10, 11]
#   End of stuff
...
if __name__ == '__main__':
    ...
    for ts_id in lunch_ids:
        ...
        if lunch_sections.count() == 0:
            new_section = lunch_subject.add_section(status=10, duration=event.duration().seconds / 3600.0)
