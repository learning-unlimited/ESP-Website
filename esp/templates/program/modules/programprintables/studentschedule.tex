...
{% if cls.event_type.description == "Compulsory" %}{{ cls.description }}{% elif cls.title|length_is:"0" %}N/A{% else %}{{ cls.title|truncatewords_char:45|texescape }}{% endif %}{% if cls.parent_class.getTeacherNames %} \newline
{% if "teacher_profile_pronoun_field"|getBooleanTag %}
