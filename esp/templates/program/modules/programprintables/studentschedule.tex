...
%   includehead/head reserve space for the \Huge banner below inside the top
%   margin, so tightening the margins cannot push the header off the page.
\usepackage[left=.5in,right=.5in,top=.4in,bottom=.5in,includehead,head=30pt,headsep=8pt]{geometry}
