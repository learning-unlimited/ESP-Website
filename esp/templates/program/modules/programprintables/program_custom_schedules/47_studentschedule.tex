...
{{ cls.friendly_times|join:", " }} & {% if not cls.locations.exists %}N/A{% else %}{{ cls.prettyrooms|join:", "|texescape }}{% endif %} & {{ cls.emailcode }} : {{ cls.title|texescape }}{% comment %} & {{ cls.parent_class.getTeacherNames|join:", "|texescape }}{% endcomment %} \\ 
{% endfor %}\hline
\end{tabularx}
