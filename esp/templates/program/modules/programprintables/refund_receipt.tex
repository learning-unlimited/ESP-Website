...
\\
By signing below, I, \underline{ {{ payer_name|texescape }} }, assert that I have paid ESP \textsterling {{ amount }} on {{ transaction.update_ts|date:"F d, Y" }} and that the credit card I used is under the address (bolded) above.
