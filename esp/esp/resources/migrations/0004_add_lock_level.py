...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ResourceAssignment.lock_level'
        db.add_column('resources_resourceassignment', 'lock_level', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

    def backwards(self, orm):
        
        # Deleting field 'ResourceAssignment.lock_level'
        db.delete_column('resources_resourceassignment', 'lock_level')
    ...
    models = {
        ...
        'program.program': {
            ...
            'class_size_max': ('django.db.models.fields.IntegerField', [], {'default': '200'}),
            'class_size_min': ('django.db.models.fields.IntegerField', [], {'default': '5'}),
