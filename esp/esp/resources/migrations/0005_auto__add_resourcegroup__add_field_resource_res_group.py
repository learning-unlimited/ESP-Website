...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('resources_resourcegroup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('resources', ['ResourceGroup'])

        # Adding field 'Resource.res_group'
        db.add_column('resources_resource', 'res_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['resources.ResourceGroup'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ResourceGroup'
        db.delete_table('resources_resourcegroup')

        # Deleting field 'Resource.res_group'
        db.delete_column('resources_resource', 'res_group_id')
    ...
    models = {
        ...
        'resources.resource': {
            ...
            'res_group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['resources.ResourceGroup']", 'null': 'True'}),
