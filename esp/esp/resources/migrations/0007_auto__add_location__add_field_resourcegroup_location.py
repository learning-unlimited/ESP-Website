...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('resources_location', (
            ...
            ('admin_notes', self.gf('django.db.models.fields.TextField')()),
            ('teacher_notes', self.gf('django.db.models.fields.TextField')()),
            ('student_notes', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('resources', ['Location'])

        # Adding field 'ResourceGroup.location'
        db.add_column('resources_resourcegroup', 'location',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['resources.Location'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ResourceGroup.location'
        db.delete_column('resources_resourcegroup', 'location_id')
