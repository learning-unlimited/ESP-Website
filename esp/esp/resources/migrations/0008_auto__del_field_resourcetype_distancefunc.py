...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ResourceType.distancefunc'
        db.delete_column('resources_resourcetype', 'distancefunc')


    def backwards(self, orm):
        # Adding field 'ResourceType.distancefunc'
        db.add_column('resources_resourcetype', 'distancefunc',
