    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "resource",
                    models.ForeignKey(
                        to="resources.Resource", on_delete=models.CASCADE
                    ),
                ),
                (
                    "target",
                    models.ForeignKey(
                        to="program.ClassSection", null=True, on_delete=models.CASCADE
                    ),
                ),
                (
                    "target_subj",
                    models.ForeignKey(
                        to="program.ClassSubject", null=True, on_delete=models.CASCADE
                    ),
                ),
            ],
        ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                to="resources.ResourceType", on_delete=django.db.models.deletion.PROTECT
            ),
        ),
        migrations.AddField(
            model_name="resourcerequest",
