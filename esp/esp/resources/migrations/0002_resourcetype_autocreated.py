...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ResourceType.autocreated'
        db.add_column('resources_resourcetype', 'autocreated', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ResourceType.autocreated'
        db.delete_column('resources_resourcetype', 'autocreated')
