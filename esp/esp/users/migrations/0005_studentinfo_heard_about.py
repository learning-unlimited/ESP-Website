...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StudentInfo.heard_about'
        db.add_column('users_studentinfo', 'heard_about', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'StudentInfo.heard_about'
        db.delete_column('users_studentinfo', 'heard_about')
