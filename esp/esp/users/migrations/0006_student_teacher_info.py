...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TeacherInfo.full_legal_name'
        db.add_column('users_teacherinfo', 'full_legal_name', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True), keep_default=False)

        # Adding field 'TeacherInfo.university_email'
        db.add_column('users_teacherinfo', 'university_email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True), keep_default=False)

        # Adding field 'TeacherInfo.student_id'
        db.add_column('users_teacherinfo', 'student_id', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True), keep_default=False)

        # Adding field 'TeacherInfo.mail_reimbursement'
        db.add_column('users_teacherinfo', 'mail_reimbursement', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Adding field 'StudentInfo.food_preference'
        db.add_column('users_studentinfo', 'food_preference', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True), keep_default=False)

        # Adding field 'StudentInfo.shirt_size'
        db.add_column('users_studentinfo', 'shirt_size', self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True), keep_default=False)

        # Adding field 'StudentInfo.shirt_type'
        db.add_column('users_studentinfo', 'shirt_type', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True), keep_default=False)

        # Adding field 'EducatorInfo.k12school'
        db.add_column('users_educatorinfo', 'k12school', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.K12School'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TeacherInfo.full_legal_name'
        db.delete_column('users_teacherinfo', 'full_legal_name')

        # Deleting field 'TeacherInfo.university_email'
        db.delete_column('users_teacherinfo', 'university_email')

        # Deleting field 'TeacherInfo.student_id'
        db.delete_column('users_teacherinfo', 'student_id')

        # Deleting field 'TeacherInfo.mail_reimbursement'
        db.delete_column('users_teacherinfo', 'mail_reimbursement')

        # Deleting field 'StudentInfo.food_preference'
        db.delete_column('users_studentinfo', 'food_preference')

        # Deleting field 'StudentInfo.shirt_size'
        db.delete_column('users_studentinfo', 'shirt_size')

        # Deleting field 'StudentInfo.shirt_type'
        db.delete_column('users_studentinfo', 'shirt_type')

        # Deleting field 'EducatorInfo.k12school'
        db.delete_column('users_educatorinfo', 'k12school_id')
