...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StudentInfo.schoolsystem_id'
        db.add_column('users_studentinfo', 'schoolsystem_id', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'StudentInfo.schoolsystem_id'
        db.delete_column('users_studentinfo', 'schoolsystem_id')
