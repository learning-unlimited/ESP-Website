...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.alter_column('users_contactinfo', 'address_state', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

    def backwards(self, orm):
        db.alter_column('users_contactinfo', 'address_state', self.gf('django.db.models.fields.CharField')(max_length=2, null=True))
