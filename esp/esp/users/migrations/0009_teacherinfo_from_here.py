...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TeacherInfo.from_here'
        db.add_column('users_teacherinfo', 'from_here', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TeacherInfo.from_here'
        db.delete_column('users_teacherinfo', 'from_here')
