...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StudentInfo.medical_needs'
        db.add_column('users_studentinfo', 'medical_needs', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'StudentInfo.medical_needs'
        db.delete_column('users_studentinfo', 'medical_needs')
