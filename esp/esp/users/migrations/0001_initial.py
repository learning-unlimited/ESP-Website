    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_day', models.CharField(max_length=20, null=True, verbose_name='Home phone', blank=True)),
                ('phone_cell', models.CharField(max_length=20, null=True, verbose_name='Cell phone', blank=True)),
                ('receive_txt_message', models.BooleanField(default=False)),
                ('phone_even', models.CharField(max_length=20, null=True, verbose_name='Alternate phone', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time', models.DateTimeField(default=_tz.now, blank=True)),
                ('program', models.ForeignKey(blank=True, to='program.Program', null=True, on_delete=models.CASCADE)),
            ],
        ),
        migrations.CreateModel(
