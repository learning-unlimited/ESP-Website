    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "phone_day",
                    models.CharField(
                        max_length=20, null=True, verbose_name="Home phone", blank=True
                    ),
                ),
                (
                    "phone_cell",
                    models.CharField(
                        max_length=20, null=True, verbose_name="Cell phone", blank=True
                    ),
                ),
                ...
                (
                    "address_city",
                    models.CharField(
                        max_length=50, null=True, verbose_name="City", blank=True
                    ),
                ),
                (
                    "address_state",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "grades",
                    models.TextField(
                        help_text='i.e. "PK, K, 1, 2, 3"', null=True, blank=True
                    ),
                ),
                (
                    "school_id",
                        ...
                        choices=[
                            ...
                            (
                                ...
                                (
                                    ...
                                    (
                                        "Student/OverrideFull",
                                        "Register for a full program",
                                    ),
                                    ...
                                    (
                                        "Student/Finaid",
                                        "Access to financial aid application",
                                    ),
                                ),
                            ),
                            (
                ...
                (
                    ...
                    models.CharField(
                        ...
                        choices=[
                            ...
                            (
                                "teacher_training",
                                "Attended teacher-training for a program",
                            ),
                            (
                                "teacher_checked_in",
                                "Teacher checked in for teaching on the day of the program",
                            ),
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=20,
                        null=True,
                        choices=[("M", "Plain"), ("F", "Fitted (for women)")],
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "priority",
                    models.DecimalField(default="1.0", max_digits=3, decimal_places=2),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "zip_code",
                    models.ForeignKey(to="users.ZipCode", on_delete=models.CASCADE),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                related_name="requesting_student_set",
                to="users.ESPUser",
                on_delete=models.CASCADE,
            ),
        ),
        migrations.AddField(
            ...
            name="user",
            field=esp.db.fields.AjaxForeignKey(
                to="users.ESPUser", unique=True, on_delete=models.CASCADE
            ),
        ),
        migrations.AddField(
            ...
            name="k12school",
            field=models.ForeignKey(
                blank=True, to="users.K12School", null=True, on_delete=models.CASCADE
            ),
        ),
        migrations.AddField(
            model_name="educatorinfo",
