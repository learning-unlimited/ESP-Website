...
def revert_q_filters(apps, schema_editor):
    PersistentQueryFilter = apps.get_model('users', 'PersistentQueryFilter')
    for pqf in PersistentQueryFilter.objects.all():
        q_filter = pickle.loads(pqf.q_filter)
        pqf.q_filter = dump_python2_pickle(q_filter)
        pqf.save()
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(repickle_q_filters, revert_q_filters),
    ]
