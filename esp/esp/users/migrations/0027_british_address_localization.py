...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContactInfo.address_locality'
        db.add_column('users_contactinfo', 'address_locality',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


        # Changing field 'ContactInfo.address_state'
        db.alter_column('users_contactinfo', 'address_state', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'ContactInfo.address_zip'
        db.alter_column('users_contactinfo', 'address_zip', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

    def backwards(self, orm):
        # Deleting field 'ContactInfo.address_locality'
        db.delete_column('users_contactinfo', 'address_locality')


        # Changing field 'ContactInfo.address_state'
        db.alter_column('users_contactinfo', 'address_state', self.gf('django.contrib.localflavor.us.models.USStateField')(max_length=2, null=True))

        # Changing field 'ContactInfo.address_zip'
        db.alter_column('users_contactinfo', 'address_zip', self.gf('django.db.models.fields.CharField')(max_length=5, null=True))
    ...
    models = {
        ...
        'users.contactinfo': {
            ...
            'address_locality': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'blank': 'True'}),
            ...
            'address_zip': ('django.db.models.fields.CharField', [], {'max_length': '15', 'null': 'True', 'blank': 'True'}),
