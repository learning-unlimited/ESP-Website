...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GradeChangeRequest'
        db.create_table('users_gradechangerequest', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('claimed_grade', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('reason', self.gf('django.db.models.fields.TextField')()),
            ('approved_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('requesting_student', self.gf('django.db.models.fields.related.ForeignKey')(related_name='requesting_student_set', to=orm['auth.User'])),
            ('approved_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
        ))
        db.send_create_signal('users', ['GradeChangeRequest'])


    def backwards(self, orm):
        # Deleting model 'GradeChangeRequest'
        db.delete_table('users_gradechangerequest')
