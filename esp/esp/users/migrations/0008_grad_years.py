...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'TeacherInfo.graduation_year'
        db.delete_column('users_teacherinfo', 'graduation_year')

        # Deleting field 'TeacherInfo.is_graduate_student'
        db.delete_column('users_teacherinfo', 'is_graduate_student')
