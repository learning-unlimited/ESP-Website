...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StudentInfo.post_hs'
        db.add_column('users_studentinfo', 'post_hs', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)

        # Adding field 'StudentInfo.transportation'
        db.add_column('users_studentinfo', 'transportation', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'StudentInfo.post_hs'
        db.delete_column('users_studentinfo', 'post_hs')

        # Deleting field 'StudentInfo.transportation'
        db.delete_column('users_studentinfo', 'transportation')
    ...
    models = {
        ...
        'users.studentinfo': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'k12school': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['users.K12School']", 'null': 'True', 'blank': 'True'}),
            'post_hs': ('django.db.models.fields.TextField', [], {'default': "''"}),
            ...
            'transportation': ('django.db.models.fields.TextField', [], {'default': "''"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'users.teacherinfo': {
