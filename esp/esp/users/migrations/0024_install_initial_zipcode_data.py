...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        """
        Install the initial fixture data for the users.models.ZipCode model.

        We do this as a migration instead of an initial_data fixture because
        then it would install on every syncdb and migration, which is
        undesirable since it takes a few minutes to install.
        """

        # Hack to get the JSON deserializer to output instances of the frozen
        # orm models instead of instances of the defined Django app models.
        # Copied from <http://stackoverflow.com/questions/5472925/django-loading-data-from-fixture-after-backward-migration-loaddata-is-using-mo/5906258#5906258>
        import django.core.serializers.python
        old_get_model = django.core.serializers.python._get_model
        new_get_model = lambda model_identifier: orm[model_identifier]
        django.core.serializers.python._get_model = new_get_model
        ...
        try:
            ...
            django.core.serializers.python._get_model = old_get_model
