...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ContactInfo.receive_txt_message'
        db.add_column('users_contactinfo', 'receive_txt_message', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ContactInfo.receive_txt_message'
        db.delete_column('users_contactinfo', 'receive_txt_message')
