...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GradeChangeRequest.grade_before_request'
        db.add_column('users_gradechangerequest', 'grade_before_request',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GradeChangeRequest.grade_before_request'
        db.delete_column('users_gradechangerequest', 'grade_before_request')
