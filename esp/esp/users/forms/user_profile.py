...
class UserContactForm(FormUnrestrictedOtherUser, FormWithTagInitialValues):
    ...
    phone_day = UKPhoneNumberField(required=False)
    phone_cell = UKPhoneNumberField(required=False)
    receive_txt_message = forms.TypedChoiceField(coerce=lambda x: x =='True', choices=((True, 'Yes'),(False, 'No')), widget=forms.RadioSelect)
    address_street = StrippedCharField(required=True, length=40, max_length=100, label='Number and Street')
    address_locality = StrippedCharField(required=True, length=40, max_length=255, required=False, initial='', label='Locality')
    address_city = StrippedCharField(required=True, length=20, max_length=50, label='Town')
    address_state = StrippedCharField(required=True, length=20, max_length=255, label='County')
    address_zip = StrippedCharField(required=True, length=7, max_length=7, widget=forms.TextInput(attrs={'class': 'input-small'}), label='Postal code')
...
class EmergContactForm(FormUnrestrictedOtherUser):
    ...
    emerg_phone_day = UKPhoneNumberField()
    emerg_phone_cell = UKPhoneNumberField(required=False)
    emerg_address_street = StrippedCharField(length=40, max_length=100, label='Number and Street')
    emerg_address_locality = StrippedCharField(length=40, max_length=255, required=False, initial='', label='Locality')
    emerg_address_city = StrippedCharField(length=20, max_length=50, label='Town')
    emerg_address_state = StrippedCharField(length=20, max_length=255, label='County')
    emerg_address_zip = StrippedCharField(length=7, max_length=7, widget=forms.TextInput(attrs={'class': 'input-small'}), label='Postal code')
...
class GuardContactForm(FormUnrestrictedOtherUser):
    ...
    guard_phone_day = UKPhoneNumberField()
    guard_phone_cell = UKPhoneNumberField(required=False)
...
class MinimalUserInfo(FormUnrestrictedOtherUser):
    ...
    last_name = StrippedCharField(length=30, max_length=64)
    e_mail = forms.EmailField()
    address_street = StrippedCharField(length=40, max_length=100, label='Number and Street')
    address_locality = StrippedCharField(length=40, max_length=255, required=False, initial='', label='Locality')
    address_city = StrippedCharField(length=20, max_length=50, label='Town')
    address_state = StrippedCharField(length=20, max_length=255, label='County')
    address_zip = StrippedCharField(length=7, max_length=7, label='Postal code')
    address_postal = forms.CharField(required=False, widget=forms.HiddenInput())
