...
class StudentInfoForm(FormUnrestrictedOtherUser):
    ...
    def __init__(self, user=None, *args, **kwargs):
        ...
        self.fields["graduation_year"].choices = [("", "")] + [
            (str(ESPUser.YOGFromGrade(x)), str(x)) for x in ESPUser.grade_options()
        ]
...
class TeacherInfoForm(FormWithRequiredCss):
    ...
    affiliation = DropdownOtherField(
        ...
        label="What is your affiliation with %s?" % settings.INSTITUTION_NAME,
    )
    ...
    def clean(self):
        ...
        if "affiliation" in self.fields:
            ...
            if affiliation == "":
                msg = (
                    "Please select your affiliation with %s."
                ...
                if school.strip() == "":
                    ...
                    if affiliation == AFFILIATION_OTHER:
                        msg = (
                            "Please enter your affiliation with %s."
                            % settings.INSTITUTION_NAME
                        )
    ...
    def __init__(self, *args, **kwargs):
        ...
        for field_name in [
            ...
            if (
                ...
                and field_name
                not in _undeletable_fields_all + _undeletable_fields_students
            ):
    ...
    def __init__(self, *args, **kwargs):
        ...
        for field_name in [
            ...
            if (
                field_name in self.fields
                and field_name
                not in _undeletable_fields_all + _undeletable_fields_teachers
            ):
                del self.fields[field_name]
