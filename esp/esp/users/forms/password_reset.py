...
class UserPasswdForm(FormWithRequiredCss):
    ...
    newpasswd = SizedCharField(length=12, min_length=8, max_length=32, widget=forms.PasswordInput())
    newpasswdconfirm = SizedCharField(length=12, min_length=8, max_length=32, widget=forms.PasswordInput())
