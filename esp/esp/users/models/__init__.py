...
class ContactInfo(models.Model, CustomFormsLinkModel):
    ...
    address_street = models.CharField('Number and Street',max_length=100,blank=True, null=True)
    address_locality = models.CharField('Locality', max_length=255, blank=True, null=False, default='')
    address_city = models.CharField('Town',max_length=50,blank=True, null=True)
    address_state = models.CharField('County',blank=True, null=True, max_length=255)
    address_zip = models.CharField('Postal code',max_length=15,blank=True, null=True)
