...
class Record(models.Model):
    ...
    EVENT_CHOICES=(
        ...
        ("minorspolicy_affiliated","Acknowledged minors policy: affiliated"),
        ("minorspolicy_recent_check","Acknowledged minors policy: recently received background check"),
        ("minorspolicy_commit_check","Acknowledged minors policy: committed to getting background check"),
