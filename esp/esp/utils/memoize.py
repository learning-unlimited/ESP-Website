## Some stock memoization techniques

# This code from <http://code.activestate.com/recipes/498245-lru-cache-decorator/>
# Use permitted under the Python Software Foundation license: <http://www.python.org/psf/license/>
# The Free Software Foundation considers this license to be a GPL-compatible Free Software license.
...
def lru_cache(maxsize):
    ...
    def decorating_function(f):
        ...
        def wrapper(*args_lst, **kwargs):
            args = (args_lst, tuple(sorted(kwargs.items())))
            ...
            try:
                ...
                result = _cache[args] = f(*args_lst, **kwargs)
                wrapper.misses += 1
