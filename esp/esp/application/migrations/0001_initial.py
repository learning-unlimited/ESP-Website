        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        help_text="An HTML template for what teachers see when they view an app. To\ninclude the content of a field, use {{field.12345}} where 12345 is the\nfield id.",
                        blank=True,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.IntegerField(
                        default=0,
                        choices=[(0, "Unassigned"), (1, "Admitted"), (2, "Waitlist")],
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.IntegerField(
                        default=0,
                        choices=[(0, "Unreviewed"), (1, "Approved"), (-1, "Rejected")],
                    ),
                ),
                ...
                (
                    "app_type",
                    models.CharField(
                        max_length=80, choices=[("Formstack", "Formstack")]
                    ),
                ),
