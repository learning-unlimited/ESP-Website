...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FormstackAppSettings.coreclass_fields'
        db.add_column('application_formstackappsettings', 'coreclass_fields',
                      self.gf('django.db.models.fields.CommaSeparatedIntegerField')(default='', max_length=80, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FormstackAppSettings.coreclass_fields'
        db.delete_column('application_formstackappsettings', 'coreclass_fields')
