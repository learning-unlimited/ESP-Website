...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FormstackAppSettings.coreclass2_field'
        db.delete_column('application_formstackappsettings', 'coreclass2_field')

        # Deleting field 'FormstackAppSettings.coreclass1_field'
        db.delete_column('application_formstackappsettings', 'coreclass1_field')

        # Deleting field 'FormstackAppSettings.coreclass3_field'
        db.delete_column('application_formstackappsettings', 'coreclass3_field')


    def backwards(self, orm):
        # Adding field 'FormstackAppSettings.coreclass2_field'
        db.add_column('application_formstackappsettings', 'coreclass2_field',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'FormstackAppSettings.coreclass1_field'
        db.add_column('application_formstackappsettings', 'coreclass1_field',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'FormstackAppSettings.coreclass3_field'
        db.add_column('application_formstackappsettings', 'coreclass3_field',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)
