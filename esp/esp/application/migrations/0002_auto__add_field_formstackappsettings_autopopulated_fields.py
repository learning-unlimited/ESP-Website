...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FormstackAppSettings.autopopulated_fields'
        db.add_column('application_formstackappsettings', 'autopopulated_fields',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FormstackAppSettings.autopopulated_fields'
        db.delete_column('application_formstackappsettings', 'autopopulated_fields')
