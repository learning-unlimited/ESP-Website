...
class EmailListPopulationTestCase(TestCase):
    ...
    def test_class_list_handler_exists(self):
        ...
        self.assertGreater(
            class_lists.count(), 0, "ClassList handler not found in EmailList entries"
        )
    ...
    def test_plain_list_handler_exists(self):
        ...
        self.assertGreater(
            plain_lists.count(), 0, "PlainList handler not found in EmailList entries"
        )
