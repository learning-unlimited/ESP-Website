    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('regex', models.CharField(help_text="(e.g. '^(.*)$' matches everything)", max_length=512, verbose_name='Regular Expression')),
                ('seq', models.PositiveIntegerField(help_text='Smaller is earlier.', verbose_name='Sequence', blank=True)),
                ...
                ('cc_all', models.BooleanField(default=False, help_text='If true, the CC field will list everyone. Otherwise each email will be sent individually.')),
                ('from_email', models.CharField(help_text='If specified, the FROM header will be overwritten with this email.', max_length=512, null=True, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(help_text='The time this object was created at. Useful for informational purposes, and also as a safety mechanism for preventing un-sent (because of previous bugs and failures), out-of-date messages from being sent.', editable=False)),
