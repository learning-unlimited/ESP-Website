        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        default="",
                        help_text="The function that specifies, for each recipient of the message, which set of associated email addresses should receive the message.",
                        max_length=128,
                        verbose_name="sendto function",
                        choices=[
                            ("", "send to user"),
                            ...
                            (
                                ...
                                "send to guardian and emergency contact",
                            ),
                            (
                ...
                (
                    ...
                    models.DateTimeField(
                        ...
                        help_text="The time this object was created at. Useful for informational purposes, and also as a safety mechanism for preventing un-sent (because of previous bugs and failures), out-of-date messages from being sent.",
                        editable=False,
                    ),
                ),
                ...
                (
                    "processed_by",
                    models.DateTimeField(default=None, null=True, db_index=True),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "messagerequest",
                    models.ForeignKey(
                        to="dbmail.MessageRequest", on_delete=models.CASCADE
                    ),
                ),
            ],
            options={
