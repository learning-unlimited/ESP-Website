...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MessageRequest.sendto_fn_name'
        db.add_column('dbmail_messagerequest', 'sendto_fn_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MessageRequest.sendto_fn_name'
        db.delete_column('dbmail_messagerequest', 'sendto_fn_name')
