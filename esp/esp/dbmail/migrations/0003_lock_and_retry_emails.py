...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TextOfEmail.locked'
        db.add_column('dbmail_textofemail', 'locked',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'TextOfEmail.tries'
        db.add_column('dbmail_textofemail', 'tries',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TextOfEmail.locked'
        db.delete_column('dbmail_textofemail', 'locked')

        # Deleting field 'TextOfEmail.tries'
        db.delete_column('dbmail_textofemail', 'tries')
