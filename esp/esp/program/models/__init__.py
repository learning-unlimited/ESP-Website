...
class Program(models.Model, CustomFormsLinkModel):
    ...
    class_categories = models.ManyToManyField('ClassCategories',
                                              blank=True,
                                              help_text='You can add new categories or modify existing ones <a href="/manage/catsflagsrecs">here</a>.')

    flag_types = models.ManyToManyField('ClassFlagType',
                    blank=True,
                    help_text='The set of flags that can be used to tag classes for this program. You can add and modify flag types <a href="/manage/catsflagsrecs">here</a>.')
