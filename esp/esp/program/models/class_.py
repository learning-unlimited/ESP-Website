...
class ClassSubject(models.Model, CustomFormsLinkModel):
    ...
    class_style = models.TextField(blank=True, default="")
    hardness_rating = models.TextField(blank=True, default="")
    class_size_max = models.IntegerField(blank=True, null=True)
    schedule = models.TextField(blank=True)
    prereqs  = models.TextField(blank=True, default="")
    requested_special_resources = models.TextField(blank=True, default="")
    directors_notes = models.TextField(blank=True, default="")
    requested_room = models.TextField(blank=True, default="")
    session_count = models.IntegerField(default=1)

    purchase_requests = models.TextField(blank=True, default="")
