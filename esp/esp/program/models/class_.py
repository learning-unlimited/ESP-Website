...
class ClassSubject(models.Model, CustomFormsLinkModel):
    ...
    allow_lateness = models.BooleanField(default=False, help_text='If checked, students may join this class after it has started.')
    message_for_directors = models.TextField(blank=True, help_text='A private message visible only to program directors, not students.')
    class_size_optimal = models.IntegerField(blank=True, null=True, help_text='The ideal number of students for this class, used when no maximum is set.')
    ...
    grade_min = models.IntegerField(help_text='Minimum grade level eligible to take this class (e.g., 7 for 7th grade).')
    grade_max = models.IntegerField(help_text='Maximum grade level eligible to take this class (e.g., 12 for 12th grade).')
    class_size_min = models.IntegerField(blank=True, null=True, help_text='Minimum number of students required for this class to run.')
    class_style = models.TextField(blank=True, null=True)
    hardness_rating = models.TextField(blank=True, null=True)
    class_size_max = models.IntegerField(blank=True, null=True, help_text='Maximum number of students allowed in this class.')
    ...
    session_count = models.IntegerField(default=1, help_text='Number of sessions (days) this class meets.')
