...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('program_registrationtype', 'displayName', self.gf('django.db.models.fields.TextField')(null=False, blank=True, default=""), keep_default=True)
        
    def backwards(self, orm):
        
        # Removing unique constraint on 'RegistrationType', fields ['category', 'name']
        db.delete_column('program_registrationtype', 'displayName')
    ...
    models = {
        ...
        'program.registrationprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_ts': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 28, 14, 39, 53, 937000)'}),
        ...
        'program.registrationtype': {
            ...
            'displayName': ('django.db.models.fields.CharField', [], {'max_length': '32', 'null': 'False', 'blank': 'True'})
        },
