...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProgramModule.inline_template'
        db.add_column('program_programmodule', 'inline_template', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True), keep_default=False)

        # Adding unique constraint on 'Program', fields ['anchor']
        db.create_unique('program_program', ['anchor_id'])

    def backwards(self, orm):
        
        # Removing unique constraint on 'Program', fields ['anchor']
        db.delete_unique('program_program', ['anchor_id'])

        # Deleting field 'ProgramModule.inline_template'
        db.delete_column('program_programmodule', 'inline_template')
    ...
    models = {
        ...
        'program.registrationprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_ts': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 8, 15, 45, 11, 252000)'}),
