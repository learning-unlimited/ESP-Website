...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ClassSizeRange'
        db.create_table('program_classsizerange', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('range_min', self.gf('django.db.models.fields.IntegerField')()),
            ('range_max', self.gf('django.db.models.fields.IntegerField')()),
            ('program', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['program.Program'])),
        ))
        db.send_create_signal('program', ['ClassSizeRange'])


    def backwards(self, orm):
        
        # Deleting model 'ClassSizeRange'
        db.delete_table('program_classsizerange')
    ...
    models = {
        ...
        'program.registrationprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_ts': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 9, 8, 1, 13, 34, 330642)'}),
