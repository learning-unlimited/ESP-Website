...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'FinancialAidRequest', fields ['program', 'user']
        db.create_unique('program_financialaidrequest', ['program_id', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'FinancialAidRequest', fields ['program', 'user']
        db.delete_unique('program_financialaidrequest', ['program_id', 'user_id'])
    ...
    models = {
        ...
        'program.registrationprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_ts': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 30, 0, 0)'}),
