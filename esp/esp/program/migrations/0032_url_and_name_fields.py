...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Program.name'
        db.add_column('program_program', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=80), keep_default=False)

        # Adding field 'Program.url'
        db.add_column('program_program', 'url', self.gf('django.db.models.fields.CharField')(default='', max_length=80), keep_default=False)

    def backwards(self, orm):
        
        # Deleting field 'Program.name'
        db.delete_column('program_program', 'name')

        # Deleting field 'Program.url'
        db.delete_column('program_program', 'url')
    ...
    models = {
        ...
        'program.registrationprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_ts': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 7, 0, 46, 27, 157616)'}),
