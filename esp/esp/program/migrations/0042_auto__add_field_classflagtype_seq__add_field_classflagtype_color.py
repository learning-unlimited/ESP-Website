...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClassFlagType.seq'
        db.add_column('program_classflagtype', 'seq',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ClassFlagType.color'
        db.add_column('program_classflagtype', 'color',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClassFlagType.seq'
        db.delete_column('program_classflagtype', 'seq')

        # Deleting field 'ClassFlagType.color'
        db.delete_column('program_classflagtype', 'color')
