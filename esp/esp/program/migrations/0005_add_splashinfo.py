...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'SplashInfo'
        db.delete_table('program_splashinfo')
    ...
    models = {
        ...
        'program.registrationprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_ts': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 7, 3, 23, 50, 40, 211390)'}),
            'program': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['program.Program']"}),
