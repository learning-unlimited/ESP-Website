...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'RegistrationType', fields ['category', 'name']
        db.create_unique('program_registrationtype', ['category', 'name'])

    def backwards(self, orm):
        
        # Removing unique constraint on 'RegistrationType', fields ['category', 'name']
        db.delete_unique('program_registrationtype', ['category', 'name'])
