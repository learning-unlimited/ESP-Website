...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field locations on 'ClassSection'
        m2m_table_name = db.shorten_name('program_classsection_locations')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('classsection', models.ForeignKey(orm['program.classsection'], null=False)),
            ('location', models.ForeignKey(orm['resources.location'], null=False))
        ))
        db.create_unique(m2m_table_name, ['classsection_id', 'location_id'])


    def backwards(self, orm):
        # Removing M2M table for field locations on 'ClassSection'
        db.delete_table(db.shorten_name('program_classsection_locations'))
