    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "label",
                    models.CharField(
                        help_text="Description of the expression", max_length=80
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        default="",
                        help_text="Boolean value, or text needed to compute it",
                        blank=True,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "member_ids",
                    models.CommaSeparatedIntegerField(max_length=100, blank=True),
                ),
                (
                    "operation",
                    models.CharField(
                        max_length=4,
                        choices=[("AND", "All"), ("OR", "Any"), ("XOR", "Exactly One")],
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "registration_status",
                    models.IntegerField(
                        default=0, choices=[(0, "open"), (10, "closed")]
                    ),
                ),
                (
                    "duration",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.EmailField(
                        default="",
                        help_text="If set, automated outgoing mail (except class cancellations) will be sent to this address instead of the director email. Use this if you do not want to spam the director email with teacher class registration emails. Otherwise, leave this field blank.",
                        max_length=75,
                        blank=True,
                    ),
                ),
                (
                    ...
                    models.EmailField(
                        default="",
                        help_text="If set, confidential emails such as financial aid applications will be sent to this address instead of the director email.",
                        max_length=75,
                        blank=True,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "old_text_reminder",
                    models.NullBooleanField(db_column="text_reminder"),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "question",
                    models.TextField(
                        help_text="The prompt that your students will see."
                    ),
                ),
                (
                    "directions",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "program",
                    models.ForeignKey(to="program.Program", on_delete=models.CASCADE),
                ),
                (
                    "timeslot",
                    models.ForeignKey(to="cal.Event", on_delete=models.CASCADE),
                ),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                to="program.VolunteerRequest", on_delete=models.CASCADE
            ),
        ),
    ]
