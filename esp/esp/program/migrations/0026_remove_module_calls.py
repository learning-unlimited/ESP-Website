...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ProgramModule.summary_calls'
        db.delete_column('program_programmodule', 'summary_calls')

        # Deleting field 'ProgramModule.main_call'
        db.delete_column('program_programmodule', 'main_call')

        # Deleting field 'ProgramModule.aux_calls'
        db.delete_column('program_programmodule', 'aux_calls')

        #   Add missing inline_template fields that needed to be added after main_call was removed
        modules_models.install()

    def backwards(self, orm):
        
        # Adding field 'ProgramModule.summary_calls'
        db.add_column('program_programmodule', 'summary_calls', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True), keep_default=False)

        # Adding field 'ProgramModule.main_call'
        db.add_column('program_programmodule', 'main_call', self.gf('django.db.models.fields.CharField')(default='main', max_length=32), keep_default=False)

        # Adding field 'ProgramModule.aux_calls'
        db.add_column('program_programmodule', 'aux_calls', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'program.registrationprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_ts': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 23, 10, 57, 45, 968000)'}),
