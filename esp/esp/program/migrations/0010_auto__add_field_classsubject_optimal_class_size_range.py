...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ClassSubject.optimal_class_size_range'
        db.add_column('program_class', 'optimal_class_size_range', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['program.ClassSizeRange'], null=True, blank=True), keep_default=False)

        # Adding M2M table for field allowable_class_size_ranges on 'ClassSubject'
        db.create_table('program_class_allowable_class_size_ranges', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('classsubject', models.ForeignKey(orm['program.classsubject'], null=False)),
            ('classsizerange', models.ForeignKey(orm['program.classsizerange'], null=False))
        ))
        db.create_unique('program_class_allowable_class_size_ranges', ['classsubject_id', 'classsizerange_id'])


    def backwards(self, orm):
        
        # Deleting field 'ClassSubject.optimal_class_size_range'
        db.delete_column('program_class', 'optimal_class_size_range_id')

        # Removing M2M table for field allowable_class_size_ranges on 'ClassSubject'
        db.delete_table('program_class_allowable_class_size_ranges')
    ...
    models = {
        ...
        'program.registrationprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_ts': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 9, 8, 1, 21, 45, 997506)'}),
