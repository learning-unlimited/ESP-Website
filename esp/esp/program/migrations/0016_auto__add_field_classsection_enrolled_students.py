...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ClassSection.enrolled_students'
        db.add_column('program_classsection', 'enrolled_students', self.gf('django.db.models.fields.IntegerField')(default=-1), keep_default=False)
        from esp.program.models import ClassSection
        ClassSection.count_enrolled_students.delete_all()


    def backwards(self, orm):
        
        # Deleting field 'ClassSection.enrolled_students'
        db.delete_column('program_classsection', 'enrolled_students')
    ...
    models = {
        ...
        'program.classsection': {
            ...
            'enrolled_students': ('django.db.models.fields.IntegerField', [], {'default': '-1'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'program.registrationprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_ts': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 11, 26, 23, 29, 44, 973669)'}),
