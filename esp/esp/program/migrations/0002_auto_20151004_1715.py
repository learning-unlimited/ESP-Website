...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name="relationship",
            field=models.ForeignKey(
                to="program.RegistrationType", on_delete=models.CASCADE
            ),
        ),
        migrations.AddField(
            model_name="studentregistration",
            name="section",
            field=esp.db.fields.AjaxForeignKey(
                to="program.ClassSection", on_delete=models.CASCADE
            ),
        ),
        migrations.AddField(
            model_name="studentregistration",
        ...
        migrations.AddField(
            ...
            name="reviewer",
            field=esp.db.fields.AjaxForeignKey(
                editable=False, to="users.ESPUser", on_delete=models.CASCADE
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name="program",
            field=models.ForeignKey(
                editable=False, to="program.Program", on_delete=models.CASCADE
            ),
        ),
        migrations.AddField(
            model_name="studentapplication",
        ...
        migrations.AddField(
            ...
            name="program",
            field=esp.db.fields.AjaxForeignKey(
                to="program.Program", null=True, on_delete=models.CASCADE
            ),
        ),
        migrations.AddField(
            model_name="splashinfo",
        ...
        migrations.AddField(
            ...
            name="condition",
            field=models.ForeignKey(
                related_name="condition_constraint",
                to="program.BooleanExpression",
                on_delete=models.CASCADE,
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                help_text='The set of flags that can be used to tag classes for this program. Add flag types in <a href="/admin/program/classflagtype/">the admin panel</a>.',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                help_text='The set of enabled program functionalities. See <a href="https://github.com/learning-unlimited/ESP-Website/blob/main/docs/admin/program_modules.rst">the documentation</a> for details.',
                to="program.ProgramModule",
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name="meeting_times",
            field=models.ManyToManyField(
                related_name="meeting_times", to="cal.Event", blank=True
            ),
        ),
        migrations.AddField(
            model_name="classsection",
        ...
        migrations.AddField(
            ...
            name="registrations",
            field=models.ManyToManyField(
                to="users.ESPUser", through="program.StudentRegistration"
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name="flag_type",
            field=models.ForeignKey(
                to="program.ClassFlagType", on_delete=models.CASCADE
            ),
        ),
        migrations.AddField(
            model_name="classflag",
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "scheduletesttimeblock_ptr",
                    models.OneToOneField(
                        parent_link=True,
                        auto_created=True,
                        primary_key=True,
                        serialize=False,
                        to="program.ScheduleTestTimeblock",
                        on_delete=models.CASCADE,
                    ),
                ),
                (
