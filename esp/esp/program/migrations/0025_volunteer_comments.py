...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'VolunteerOffer.comments'
        db.add_column('program_volunteeroffer', 'comments', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

    def backwards(self, orm):
        
        # Deleting field 'VolunteerOffer.comments'
        db.delete_column('program_volunteeroffer', 'comments')
    ...
    models = {
        ...
        'program.registrationprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_ts': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 10, 8, 22, 49, 59, 235000)'}),
