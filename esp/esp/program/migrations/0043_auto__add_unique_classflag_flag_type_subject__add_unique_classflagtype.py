...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'ClassFlag', fields ['flag_type', 'subject']
        db.create_unique('program_classflag', ['flag_type_id', 'subject_id'])

        # Adding unique constraint on 'ClassFlagType', fields ['name']
        db.create_unique('program_classflagtype', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'ClassFlagType', fields ['name']
        db.delete_unique('program_classflagtype', ['name'])

        # Removing unique constraint on 'ClassFlag', fields ['flag_type', 'subject']
        db.delete_unique('program_classflag', ['flag_type_id', 'subject_id'])
    ...
    models = {
        ...
        'program.classflag': {
            'Meta': {'ordering': "['flag_type']", 'unique_together': "(('subject', 'flag_type'),)", 'object_name': 'ClassFlag'},
        ...
        'program.registrationprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_ts': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 26, 0, 0)'}),
