...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field teachers on 'ClassSubject'
        db.create_table('program_class_teachers', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('classsubject', models.ForeignKey(orm['program.classsubject'], null=False)),
            ('espuser', models.ForeignKey(orm['users.espuser'], null=False))
        ))
        db.create_unique('program_class_teachers', ['classsubject_id', 'espuser_id'])

    def backwards(self, orm):
        
        # Removing M2M table for field teachers on 'ClassSubject'
        db.delete_table('program_class_teachers')
    ...
    models = {
        ...
        'program.registrationprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_ts': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 2, 1, 52, 4, 509773)'}),
