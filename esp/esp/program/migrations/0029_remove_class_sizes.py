...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RegistrationType.displayName'
        db.alter_column('program_registrationtype', 'displayName', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

        # Deleting field 'Program.class_size_max'
        db.delete_column('program_program', 'class_size_max')

        # Deleting field 'Program.class_size_min'
        db.delete_column('program_program', 'class_size_min')

    def backwards(self, orm):
        
        # Changing field 'RegistrationType.displayName'
        db.alter_column('program_registrationtype', 'displayName', self.gf('django.db.models.fields.CharField')(default='', max_length=32, null=False))

        # Adding field 'Program.class_size_max'
        db.add_column('program_program', 'class_size_max', self.gf('django.db.models.fields.IntegerField')(default=1000), keep_default=False)

        # Adding field 'Program.class_size_min'
        db.add_column('program_program', 'class_size_min', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
    ...
    models = {
        ...
        'program.registrationprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_ts': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 29, 20, 5, 5, 45000)'}),
