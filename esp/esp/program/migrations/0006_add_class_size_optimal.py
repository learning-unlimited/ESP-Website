...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ClassSubject.class_size_optimal'
        db.add_column('program_class', 'class_size_optimal', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ClassSubject.class_size_optimal'
        db.delete_column('program_class', 'class_size_optimal')
    ...
    models = {
        ...
        'program.registrationprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_ts': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 7, 4, 0, 33, 17, 963751)'}),
            'program': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['program.Program']"}),
        ...
        'users.teacherinfo': {
            ...
            'from_mit': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
