...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'VolunteerOffer.shirt_size'
        db.add_column('program_volunteeroffer', 'shirt_size', self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True), keep_default=False)

        # Adding field 'VolunteerOffer.shirt_type'
        db.add_column('program_volunteeroffer', 'shirt_type', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'VolunteerOffer.shirt_size'
        db.delete_column('program_volunteeroffer', 'shirt_size')

        # Deleting field 'VolunteerOffer.shirt_type'
        db.delete_column('program_volunteeroffer', 'shirt_type')
    ...
    models = {
        ...
        'program.registrationprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_ts': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 6, 23, 35, 56, 229000)'}),
