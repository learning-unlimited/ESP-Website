...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'VolunteerRequest'
        db.create_table('program_volunteerrequest', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('program', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['program.Program'])),
            ('timeslot', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cal.Event'])),
            ('num_volunteers', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal('program', ['VolunteerRequest'])

        # Adding model 'VolunteerOffer'
        db.create_table('program_volunteeroffer', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('request', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['program.VolunteerRequest'])),
        ...
        db.send_create_signal('program', ['VolunteerOffer'])

    def backwards(self, orm):
        
        # Deleting model 'VolunteerRequest'
        db.delete_table('program_volunteerrequest')

        # Deleting model 'VolunteerOffer'
        db.delete_table('program_volunteeroffer')
    ...
    models = {
        ...
        'program.registrationprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_ts': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 9, 11, 19, 14, 35, 78000)'}),
