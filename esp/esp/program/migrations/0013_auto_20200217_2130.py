    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.ManyToManyField(
                help_text='You can add new categories or modify existing ones from <a href="/admin/program/classcategories/">the admin panel</a>.',
        ...
        migrations.AlterField(
            ...
            field=models.EmailField(
                default="",
                help_text="If set, automated outgoing mail (except class cancellations) will be sent to this address <i>instead of</i> the director email. Use this if you do not want to spam the director email with teacher class registration emails. Otherwise, leave this field blank.",
                max_length=75,
                blank=True,
            ),
        ),
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                ...
                max_length=20,
                null=True,
                choices=[("M", "Straight cut"), ("F", "Fitted cut")],
            ),
        ),
    ]
