...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ClassSubject.custom_form_data'
        db.add_column('program_class', 'custom_form_data', self.gf('esp.utils.fields.JSONField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ClassSubject.custom_form_data'
        db.delete_column('program_class', 'custom_form_data')
    ...
    models = {
        ...
        'program.registrationprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_ts': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 6, 22, 38, 51, 615000)'}),
