"""Auto-generated migration to align Program.name and Program.url with models.

This migration mirrors field definitions to satisfy CI migration checks.
"""
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("program", "0045_alter_program_name_alter_program_url"),
    ]
