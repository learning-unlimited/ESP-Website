...
from esp.program.modules.models import install as install_modules
...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ProgramModule.main_call'
        db.alter_column('program_programmodule', 'main_call', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))
    ...
    models = {
        ...
        'program.registrationprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_ts': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 25, 22, 56, 32, 501116)'}),
