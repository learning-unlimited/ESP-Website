...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StudentSubjectInterest'
        db.create_table('program_studentsubjectinterest', (
        ...
        db.send_create_signal('program', ['StudentSubjectInterest'])


        # Changing field 'StudentRegistration.end_date'
        db.alter_column('program_studentregistration', 'end_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'StudentRegistration.start_date'
        db.alter_column('program_studentregistration', 'start_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):
        # Deleting model 'StudentSubjectInterest'
        db.delete_table('program_studentsubjectinterest')


        # Changing field 'StudentRegistration.end_date'
        db.alter_column('program_studentregistration', 'end_date', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'StudentRegistration.start_date'
        db.alter_column('program_studentregistration', 'start_date', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        'program.registrationprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_ts': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 29, 0, 0)'}),
