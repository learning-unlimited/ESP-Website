...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ClassFlag'
        db.create_table('program_classflag', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('subject', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['program.ClassSubject'])),
            ('flag_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['program.ClassFlagType'])),
            ('comment', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='classflags_modified', to=orm['auth.User'])),
            ('modified_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='classflags_created', to=orm['auth.User'])),
            ('created_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('program', ['ClassFlag'])

        # Adding model 'ClassFlagType'
        db.create_table('program_classflagtype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('show_in_scheduler', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('show_in_dashboard', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('program', ['ClassFlagType'])

        # Adding M2M table for field flag_types on 'Program'
        m2m_table_name = db.shorten_name('program_program_flag_types')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('program', models.ForeignKey(orm['program.program'], null=False)),
            ('classflagtype', models.ForeignKey(orm['program.classflagtype'], null=False))
        ))
        db.create_unique(m2m_table_name, ['program_id', 'classflagtype_id'])


    def backwards(self, orm):
        # Deleting model 'ClassFlag'
        db.delete_table('program_classflag')

        # Deleting model 'ClassFlagType'
        db.delete_table('program_classflagtype')

        # Removing M2M table for field flag_types on 'Program'
        db.delete_table(db.shorten_name('program_program_flag_types'))
    ...
    models = {
        ...
        'program.classflagtype': {
            'Meta': {'object_name': 'ClassFlagType'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'program.registrationprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_ts': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 29, 0, 0)'}),
        ...
        'users.contactinfo': {
            ...
            'address_state': ('localflavor.us.forms.USStateField', [], {'max_length': '2', 'null': 'True', 'blank': 'True'}),
