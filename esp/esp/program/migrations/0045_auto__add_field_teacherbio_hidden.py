...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TeacherBio.hidden'
        db.add_column('program_teacherbio', 'hidden',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TeacherBio.hidden'
        db.delete_column('program_teacherbio', 'hidden')
    ...
    models = {
        ...
        'program.registrationprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_ts': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 13, 0, 0)'}),
