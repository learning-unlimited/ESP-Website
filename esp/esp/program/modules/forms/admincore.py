...
class LunchConstraintsForm(forms.Form):
    ...
    def load_data(self):
        lunch_timeslots = Event.objects.filter(meeting_times__parent_class__parent_program=self.program, meeting_times__parent_class__category__is_lunch=True).distinct()
