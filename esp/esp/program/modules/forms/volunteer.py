...
class VolunteerOfferForm(forms.Form):
    ...
    confirm = forms.BooleanField(help_text='<label for="id_confirm" style="color: red; font-weight: bold;"> I will be available at the time(s) selected above.</label>', required=False)
