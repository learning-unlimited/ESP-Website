...
class TeacherClassRegForm(FormWithRequiredCss):
    ...
    def __init__(self, crmi, *args, **kwargs):
        ...
        custom_helptext_fields = ['duration', 'class_size_max', 'class_size_optimal', 'num_sections', 'requested_room', 'message_for_directors', 'purchase_requests', 'class_info'] + custom_fields.keys()
