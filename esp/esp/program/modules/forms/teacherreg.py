...
class TeacherClassRegForm(FormWithRequiredCss):
    ...
    def __init__(self, crmi, *args, **kwargs):
        ...
        #   Hide the fields that teacherreg_active_fields excludes.  This runs last
        #   so that the tags above have already decided which fields are required
        #   and supplied the teacherreg_default_* initial values.
