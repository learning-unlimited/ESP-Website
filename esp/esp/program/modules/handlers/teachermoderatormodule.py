...
class TeacherModeratorModule(ProgramModuleObj):
    ...
    def moderate(self, request, tl, one, two, module, extra, prog):
        context = {"prog": prog}
        recs = ModeratorRecord.objects.filter(
    ...
    def teachers(self, QObject=False):
        ...
        qw = Q(
            moderatorrecord__program=self.program, moderatorrecord__will_moderate=True
        )
        ...
        return {"will_moderate": offered_list, "assigned_moderator": assigned_list}

    def teacherDesc(self):
        return {
            "will_moderate": """Teachers who have also offered to be a """
            + Tag.getProgramTag("moderator_title", self.program).lower(),
            "assigned_moderator": """Teachers who are assigned as """
            + Tag.getProgramTag("moderator_title", self.program).lower()
            + """s""",
        }
