...
def minorspolicyacknowledgementform_factory(prog):
    ...
    backgroundcheck_choices = Tag.getProgramTag('minors_backgroundcheck_choices', prog)
    backgroundcheck_label = Tag.getProgramTag('minors_backgroundcheck_label', prog)
    ...
    observing_choices = Tag.getProgramTag('minors_observing_choices', prog, default=str([
        ...
        ('other', 'Other: I will explain in an email to the directors at %s.' % prog.director_email),
    ]))
    observing_label = Tag.getProgramTag('minors_observing_label', prog)
