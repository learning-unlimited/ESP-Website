...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('allow_coteach', models.BooleanField(default=True, help_text='Check this box to allow teachers to specify co-teachers.')),
                ('set_prereqs', models.BooleanField(default=True, help_text='Check this box to allow teachers to enter prerequisites for each class that are displayed separately on the catalog.')),
                ('class_max_duration', models.IntegerField(help_text='The maximum length of a class, in minutes.', null=True, blank=True)),
                ('class_min_cap', models.IntegerField(help_text='The minimum number of students a teacher can choose as their class capacity.', null=True, blank=True)),
                ('class_max_size', models.IntegerField(help_text='The maximum number of students a teacher can choose as their class capacity.', null=True, blank=True)),
                ('class_size_step', models.IntegerField(help_text='The interval for class capacity choices.', null=True, blank=True)),
                ('class_other_sizes', models.CommaSeparatedIntegerField(help_text="Force the addition of these options to teachers' choices of class size.  (Enter a comma-separated list of integers.)", max_length=100, null=True, blank=True)),
                ('allowed_sections', models.CommaSeparatedIntegerField(help_text='Allow this many independent sections of a class (comma separated list of integers). Leave blank to allow arbitrarily many.', max_length=100, blank=True)),
                ('session_counts', models.CommaSeparatedIntegerField(help_text='Possibilities for the number of days that a class could meet (comma separated list of integers). Leave blank if this is not a relevant choice for the teachers.', max_length=100, blank=True)),
                ('num_teacher_questions', models.PositiveIntegerField(default=1, help_text='The maximum number of application questions that can be specified for each class.', null=True, blank=True)),
                ('color_code', models.CharField(max_length=6, null=True, blank=True)),
                ('allow_lateness', models.BooleanField(default=False)),
                ('ask_for_room', models.BooleanField(default=True, help_text='If true, teachers will be asked if they have a particular classroom in mind.')),
                ...
                ('open_class_registration', models.BooleanField(default=False, help_text='If true, teachers will be presented with an option to register for an "open class".')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('action', models.CharField(default='confirm', max_length=80)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_cap_multiplier', models.DecimalField(default='1.00', help_text='A multiplier for class capacities (set to 0.5 to cap all classes at half their stored capacity).', max_digits=3, decimal_places=2)),
                ...
                ('confirm_button_text', models.CharField(default='Confirm', help_text='Label for the "confirm" button at the bottom of student reg.', max_length=80)),
                ('view_button_text', models.CharField(default='View Receipt', help_text='Label for the "get receipt" button (for already confirmed students) at the bottom of student reg.', max_length=80)),
                ('cancel_button_text', models.CharField(default='Cancel Registration', help_text='Label for the "cancel" button at the bottom of student reg.', max_length=80)),
                ('temporarily_full_text', models.CharField(default='Class temporarily full; please check back later', help_text='The text that replaces the "Add class" button when the class has reached its adjusted capacity', max_length=255)),
