    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('send_confirmation', models.BooleanField(default=False, help_text=b'Check this box to send each student an e-mail the first time they confirm their registration.  You must define an associated DBReceipt of type "confirmemail".')),
                ('show_emailcodes', models.BooleanField(default=True, help_text=b'Uncheck this box to prevent e-mail codes (i.e. E534, H243) from showing up on catalog and fillslot pages.')),
