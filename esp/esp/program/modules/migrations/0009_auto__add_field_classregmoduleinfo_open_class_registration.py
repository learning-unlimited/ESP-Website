...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ClassRegModuleInfo.open_class_registration'
        db.add_column('modules_classregmoduleinfo', 'open_class_registration', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'ClassRegModuleInfo.open_class_registration'
        db.delete_column('modules_classregmoduleinfo', 'open_class_registration')
