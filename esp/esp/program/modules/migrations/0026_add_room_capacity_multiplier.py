...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StudentClassRegModuleInfo.apply_multiplier_to_room_cap'
        db.add_column('modules_studentclassregmoduleinfo', 'apply_multiplier_to_room_cap', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

    def backwards(self, orm):
        
        # Deleting field 'StudentClassRegModuleInfo.apply_multiplier_to_room_cap'
        db.delete_column('modules_studentclassregmoduleinfo', 'apply_multiplier_to_room_cap')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 29, 17, 17, 2, 390260)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 29, 17, 17, 2, 390131)'}),
