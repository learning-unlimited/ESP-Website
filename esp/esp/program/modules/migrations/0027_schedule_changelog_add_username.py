...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AJAXChangeLogEntry.user'
        db.add_column('modules_ajaxchangelogentry', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AJAXChangeLogEntry.user'
        db.delete_column('modules_ajaxchangelogentry', 'user_id')
