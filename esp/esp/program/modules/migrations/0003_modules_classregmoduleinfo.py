...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ClassRegModuleInfo.class_min_cap'
        db.add_column('modules_classregmoduleinfo', 'class_min_cap', orm['modules.classregmoduleinfo:class_min_cap'])
        
        # Adding field 'ClassRegModuleInfo.class_other_sizes'
        db.add_column('modules_classregmoduleinfo', 'class_other_sizes', orm['modules.classregmoduleinfo:class_other_sizes'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'ClassRegModuleInfo.class_min_cap'
        db.delete_column('modules_classregmoduleinfo', 'class_min_cap')
        
        # Deleting field 'ClassRegModuleInfo.class_other_sizes'
        db.delete_column('modules_classregmoduleinfo', 'class_other_sizes')
    ...
    models = {
        ...
        'modules.studentclassregmoduleinfo': {
            ...
            'signup_verb': ('django.db.models.fields.related.ForeignKey', ["orm['datatree.DataTree']"], {}),
