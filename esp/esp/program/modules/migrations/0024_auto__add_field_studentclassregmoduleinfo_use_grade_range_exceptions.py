...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StudentClassRegModuleInfo.use_grade_range_exceptions'
        db.add_column('modules_studentclassregmoduleinfo', 'use_grade_range_exceptions', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

    def backwards(self, orm):
        
        # Deleting field 'StudentClassRegModuleInfo.use_grade_range_exceptions'
        db.delete_column('modules_studentclassregmoduleinfo', 'use_grade_range_exceptions')
