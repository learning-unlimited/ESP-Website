...
class Migration:
    ...
    models = {
        ...
        'modules.remoteprofile': {
            'bus_runs': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['datatree.DataTree']", 'symmetrical': 'False', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'volunteer_times': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['cal.Event']", 'symmetrical': 'False', 'blank': 'True'})
        },
