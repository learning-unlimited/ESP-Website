...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ClassRegModuleInfo.use_class_size_max'
        db.add_column('modules_classregmoduleinfo', 'use_class_size_max', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'ClassRegModuleInfo.use_class_size_optimal'
        db.add_column('modules_classregmoduleinfo', 'use_class_size_optimal', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'ClassRegModuleInfo.use_optimal_class_size_range'
        db.add_column('modules_classregmoduleinfo', 'use_optimal_class_size_range', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'ClassRegModuleInfo.use_allowable_class_size_ranges'
        db.add_column('modules_classregmoduleinfo', 'use_allowable_class_size_ranges', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ClassRegModuleInfo.use_class_size_max'
        db.delete_column('modules_classregmoduleinfo', 'use_class_size_max')

        # Deleting field 'ClassRegModuleInfo.use_class_size_optimal'
        db.delete_column('modules_classregmoduleinfo', 'use_class_size_optimal')

        # Deleting field 'ClassRegModuleInfo.use_optimal_class_size_range'
        db.delete_column('modules_classregmoduleinfo', 'use_optimal_class_size_range')

        # Deleting field 'ClassRegModuleInfo.use_allowable_class_size_ranges'
        db.delete_column('modules_classregmoduleinfo', 'use_allowable_class_size_ranges')
