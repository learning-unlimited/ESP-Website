...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('modules_creditcardsettings', (
            ...
            ('invoice_prefix', self.gf('django.db.models.fields.CharField')(default='umbc', max_length=80)),
            ('host_payment_form', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('offer_donation', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
    ...
    models = {
        ...
        'modules.creditcardsettings': {
            ...
            'host_payment_form': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invoice_prefix': ('django.db.models.fields.CharField', [], {'default': "'umbc'", 'max_length': '80'}),
            'module': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['modules.ProgramModuleObj']"}),
            'offer_donation': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
