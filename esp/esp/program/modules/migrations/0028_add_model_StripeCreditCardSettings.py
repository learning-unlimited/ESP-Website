...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StripeCreditCardSettings'
        db.create_table('modules_stripecreditcardsettings', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('module', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modules.ProgramModuleObj'])),
            ('publishable_key', self.gf('django.db.models.fields.CharField')(default='', max_length=255)),
            ('secret_key', self.gf('django.db.models.fields.CharField')(default='', max_length=255)),
            ('offer_donation', self.gf('django.db.models.fields.BooleanField')(default=True)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table('modules_stripecreditcardsettings')
    ...
    models = {
        ...
        'modules.stripecreditcardsettings': {
            'Meta': {'object_name': 'StripeCreditCardSettings'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invoice_prefix': ('django.db.models.fields.CharField', [], {'default': "'mit'", 'max_length': '80'}),
            'module': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['modules.ProgramModuleObj']"}),
            'offer_donation': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'publishable_key': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255'}),
            'secret_key': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255'})
        },
