...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('modules_formstackappsettings', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('module', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modules.ProgramModuleObj'])),
            ('form', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['formstack.FormstackForm'], null=True)),
            ('api_key', self.gf('django.db.models.fields.CharField')(max_length=80)),
            ('handshake_key', self.gf('django.db.models.fields.CharField')(max_length=80)),
            ('username_field', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('coreclass1_field', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('coreclass2_field', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('coreclass3_field', self.gf('django.db.models.fields.IntegerField')(null=True)),
        ))
        db.send_create_signal('modules', ['FormstackAppSettings'])


    def backwards(self, orm):
        # Deleting model 'FormstackAppSettings'
        db.delete_table('modules_formstackappsettings')
    ...
    models = {
        ...
        'formstack.formstackform': {
            'Meta': {'object_name': 'FormstackForm'},
            'id': ('django.db.models.fields.IntegerField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '80'}),
            'viewkey': ('django.db.models.fields.CharField', [], {'max_length': '80'})
        },
        ...
        'modules.creditcardsettings': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invoice_prefix': ('django.db.models.fields.CharField', [], {'default': "'l'", 'max_length': '80'}),
            'module': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['modules.ProgramModuleObj']"}),
        ...
        'modules.formstackappsettings': {
            'Meta': {'object_name': 'FormstackAppSettings'},
            'api_key': ('django.db.models.fields.CharField', [], {'max_length': '80'}),
            'coreclass1_field': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'coreclass2_field': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'coreclass3_field': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'form': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['formstack.FormstackForm']", 'null': 'True'}),
            'handshake_key': ('django.db.models.fields.CharField', [], {'max_length': '80'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'module': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['modules.ProgramModuleObj']"}),
            'username_field': ('django.db.models.fields.IntegerField', [], {'null': 'True'})
        },
