...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        #   Make AvailabilityModule required by default
        ProgramModule.objects.filter(handler='AvailabilityModule', module_type='teach').update(required=True)
    
    def backwards(self, orm):
        #   Make AvailabilityModule non-required by default
        ProgramModule.objects.filter(handler='AvailabilityModule', module_type='teach').update(required=False)
