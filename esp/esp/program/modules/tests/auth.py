    ...
    def testViewsHaveAuths(self):
        ...
        for module in modules:
            ...
            for view_name in view_names:
                ...
                self.assertTrue(
                    getattr(view, "has_auth_check", None),
    ...
    def testViewDecoratorOrder(self):
        ...
        for handler_file in sorted(handlers_dir.glob("*.py")):
            ...
            for class_node in [n for n in tree.body if isinstance(n, ast.ClassDef)]:
                for func_node in [
                    n for n in class_node.body if isinstance(n, ast.FunctionDef)
                ]:
                    decorator_names = [
                    ...
                    auth_positions = [
                        ...
                        for i, name in enumerate(decorator_names)
                        if name
                        and (name.startswith("needs_") or name in self.AUTH_DECORATORS)
                    ]
                    no_auth_positions = [
                        i for i, name in enumerate(decorator_names) if name == "no_auth"
                    ]
                    grade_positions = [
                        i
                        for i, name in enumerate(decorator_names)
                    ...
                    decorator_list = ", ".join(
                        f"@{name}" for name in decorator_names if name
                    )
                    ...
                    if (
                        auth_positions
                        and grade_positions
                        and min(auth_positions) > min(grade_positions)
                    ):
                        failures.append(
                    ...
                    if (
                        auth_positions
                        and deadline_positions
                        and min(auth_positions) > min(deadline_positions)
                    ):
                        failures.append(
                    ...
                    if (
                        grade_positions
                        and deadline_positions
                        and min(grade_positions) > min(deadline_positions)
                    ):
                        failures.append(
                    ...
                    if (
                        auth_positions
                        and cap_positions
                        and min(auth_positions) > min(cap_positions)
                    ):
                        failures.append(
                    ...
                    if (
                        grade_positions
                        and cap_positions
                        and min(grade_positions) > min(cap_positions)
                    ):
                        failures.append(
                    ...
                    if (
                        deadline_positions
                        and cap_positions
                        and min(deadline_positions) > min(cap_positions)
                    ):
                        failures.append(
                    ...
                    if (
                        no_auth_positions
                        and cache_positions
                        and min(no_auth_positions) > min(cache_positions)
                    ):
                        failures.append(
