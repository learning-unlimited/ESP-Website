...
class RegProfileModuleTest(ProgramFrameworkTest):
    ...
    def runTest(self):
        ...
        self.assertTrue(
            '<span class="form_error" role="alert">This field is required.</span>' in lines[i+j+1] or
            '<span class="form_error">This field is required.</span>' in lines[i+j+1] or
            'This field is required.' in lines[i+j+1]
        )
