...
class StripeTotalsTest(TestCase):
    def setUp(self):
        ...
        self.lit_payment = LineItemType.objects.create(
            text="Student payment", program=self.program
        )
        ...
        with patch(
            ...
            return_value=datetime.datetime(2023, 1, 15, tzinfo=datetime.timezone.utc),
        ):
    ...
    def test_fee_calculation(self):
        ...
        lit_donation = LineItemType.objects.create(
            text="Donation to Learning Unlimited", program=self.program
        )
