...
class TeacherOnsiteTest(ModuleHandlerTestMixin, ProgramFrameworkTest):
    def setUp(self, *args, **kwargs):
        ...
        RecordType.objects.get_or_create(
            ...
            defaults={
                "description": "Teacher checked in for teaching on the day of the program"
            },
        )
    ...
    def test_onsitedetails_page(self):
        ...
        self.assertTemplateUsed(
            response, "program/modules/teacheronsite/sectioninfo.html"
        )
    ...
    def test_onsiteroster_page(self):
        ...
        self.assertTemplateUsed(
            response, "program/modules/teacheronsite/sectionroster.html"
        )
