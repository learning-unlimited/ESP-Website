...
from esp.program.modules.tests.studentregprofilemodule import (
    StudentRegProfileModuleTest,
...
from esp.program.modules.tests.test_student_reg_phase_zero import (
    StudentRegPhaseZeroTestCase,
)
...
from esp.program.modules.tests.test_student_reg_phase_zero_manage import (
    StudentRegPhaseZeroManageTest,
)
from esp.program.modules.tests.test_teacherevents import (
    TeacherEventsModuleTest,
    TeacherEventsCalendarDataTest,
)
from esp.program.modules.tests.test_studentlunchselection import (
    StudentLunchSelectionTest as StudentLunchSelectionModuleTest,
)
...
from esp.program.modules.tests.test_onsiteattendance import (
    TestTimesAttendingClass,
    TestTimesCheckedIn,
)
from esp.program.modules.tests.test_addclass_concurrency import (
    AddClassConcurrencyRegressionTest,
)
...
from esp.program.modules.tests.studentjunctionappmodule import (
    StudentJunctionAppModuleTest,
)

from esp.program.modules.tests.test_donationmodule import (
    DonationFormTest,
    DonationModuleTest,
)
