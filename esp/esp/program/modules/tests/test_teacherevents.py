...
class TeacherEventsModuleTest(ProgramFrameworkTest):
    """Module methods (isStep/getTimes/teachers/isCompleted/...) and the
...
class TeacherEventsCalendarDataTest(ProgramFrameworkTest):
    """The calendar_data JSON endpoint used by the calendar-based signup UI."""
