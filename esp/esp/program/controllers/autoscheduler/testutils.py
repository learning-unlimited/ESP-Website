...
def create_test_schedule_1():
    ...
    classrooms = set([
        models.AS_Classroom("26-100", timeslots, 1),
        models.AS_Classroom("10-250", timeslots[3:], 2)])
    teachers = {
    ...
    sections = set([
        models.AS_ClassSection([teachers[1]], 0.83, 20, [], 1),
        models.AS_ClassSection([teachers[2], teachers[3]], 1.83, 50, [], 2)])
