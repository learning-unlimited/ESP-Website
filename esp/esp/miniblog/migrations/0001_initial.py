    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "href",
                    models.URLField(help_text="The URL the link should point to."),
                ),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "slug",
                    models.SlugField(
                        default="General", help_text="(will determine the URL)"
                    ),
                ),
                (
                    "timestamp",
                ...
                (
                    "fromemail",
                    models.CharField(
                        max_length=80, null=True, editable=False, blank=True
                    ),
                ),
