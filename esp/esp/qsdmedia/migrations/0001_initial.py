        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "mime_type",
                    models.CharField(
                        max_length=256, null=True, editable=False, blank=True
                    ),
                ),
                (
                    "file_extension",
                    models.TextField(
                        max_length=16, null=True, editable=False, blank=True
                    ),
                ),
                (
                    "file_name",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "media",
                    models.ForeignKey(
                        to="qsdmedia.Media", unique=True, on_delete=models.CASCADE
                    ),
                ),
            ],
        ),
