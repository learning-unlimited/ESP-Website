...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Media.anchor'
        db.delete_column('qsdmedia_media', 'anchor_id')


    def backwards(self, orm):
        # Adding field 'Media.anchor'
        db.add_column('qsdmedia_media', 'anchor',
    ...
    complete_apps = ['datatree', 'qsdmedia']