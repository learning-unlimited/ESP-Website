...
class ConfigForm(ThemeConfigurationForm):
    ...
    show_logo = forms.BooleanField(initial = True, required = False, help_text='Should the logo be shown in the page header?')
    show_group_name = forms.BooleanField(initial = True, required = False, help_text='Should the full group name be shown in the page header?')
