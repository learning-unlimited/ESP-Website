...
class ConfigForm(ThemeConfigurationForm):
    ...
    show_group_name = forms.BooleanField(
        initial=True,
        required=False,
        help_text="Should the full group name be shown in the navigation bar?",
    )
    show_logo_navbar = forms.BooleanField(
        initial=True,
        required=False,
        help_text=mark_safe("Should the logo be shown in the <b>navigation bar</b>?"),
    )
    show_logo_header = forms.BooleanField(
        initial=True,
        required=False,
        help_text=mark_safe("Should the logo be shown in the <b>header banner</b>?"),
    )
    show_header_home = forms.BooleanField(
        initial=True,
        required=False,
        help_text=mark_safe(
            "Should the header banner be shown on the <b>homepage</b>?"
        ),
    )
    show_header_other = forms.BooleanField(
        initial=True,
        required=False,
        help_text=mark_safe(
            "Should the header banner be shown on <b>non-homepage pages</b>?"
        ),
    )
    ...
    show_email = forms.BooleanField(
        required=False,
        help_text='Should the group email address be shown in the "About Us" dropdown in the navigation bar?',
    )
    ...
    nav_structure = forms.Field(
        widget=NavStructureWidgetWithIcons,
    ...
    facebook_link = forms.URLField(
        required=False,
        help_text='Supply this to link to Facebook in the "About Us" dropdown in the navigation bar. Leave blank to omit a Facebook link.',
    )
