...
function primary_to_secondary(primary_div)
{
...
function setup_nav() {
    ...
    for (let i = 0; i < primary_divs.length; i++)
    {
        ...
        primary_div.hover(function (event) {make_active(event);}, function () {make_inactive(i);});
    }
...
function setup_announcement_box() {
    $j('#new_announcement_box').click(function () {$j('#inner_announcement_box').toggleClass('box_hidden');});
}

function combined_setup() {
    setup_nav();
