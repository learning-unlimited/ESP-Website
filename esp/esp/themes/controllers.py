    ...
    def get_file_summaries(self, dir):
        ...
        for filename in os.listdir(dir):
            ...
            if os.path.isdir(full_filename):
                ...
                result.append((full_filename, os.path.getsize(full_filename), hashlib.sha256(file_data).hexdigest()))
        return result
            ...
            if rel_filename_dest in index_src:
                ...
                if hash_src != hash_dest:
                    differences.append({
                        ...
                        'filename_hash': hashlib.sha256(rel_filename_dest.encode("UTF-8")).hexdigest(),
