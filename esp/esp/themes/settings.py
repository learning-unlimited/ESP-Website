...
scss_dir = path.join(
    settings.PROJECT_ROOT, "public", "media", "theme_editor", "scss"
)  # directory containing scss files used by theme editor
themes_dir = path.join(
    settings.PROJECT_ROOT, "public", "media", "theme_editor", "themes"
)  # directory containing saved theme customizations
