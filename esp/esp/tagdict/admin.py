...
class TagAdminForm(forms.ModelForm):
    """ModelForm for Tag that validates *_active_fields/*_hide_fields tag values."""
    ...
    def clean(self):
        ...
        if key in ALL_FIELD_NAME_TAG_KEYS and value:
            result = validate_field_names_value(key, value)
