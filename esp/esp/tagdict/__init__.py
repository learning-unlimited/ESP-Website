...
all_program_tags = {
    ...
    'teacherreg_hide_fields_open': {
        'is_boolean': False,
        'help_text': 'A comma seperated list of what fields (e.g. \'purchase_requests\') you want to hide from teachers during teacher open-class registration',
        'default': None,
        'category': 'teach',
        'is_setting': True,
    },
    ...
    'program_center': {
        ...
        'default': '42.359175919119444, -71.09321309908651',
        'category': 'manage',
        'is_setting': True,
    ...
    'student_waiver_label': {
        'is_boolean': False,
        'help_text': 'Label for the checkbox on the student liability waiver form.',
        'default': 'I have completed the online liability waiver.',
        'category': 'learn',
        'is_setting': True,
    },
    'teacher_waiver_label': {
        'is_boolean': False,
        'help_text': 'Label for the checkbox on the teacher waiver form.',
        'default': 'I have completed the online code of conduct.',
        'category': 'teach',
        'is_setting': True,
    },
    'minors_backgroundcheck_choices': {
        'is_boolean': False,
        'help_text': 'JSON-formatted list of 2-element [value, label] lists for the background-check choice field on the MIT Minors Policy acknowledgement form.',
        'default': json.dumps([
            ('mit_recent_check', 'I am a current MIT affiliate who has had a valid MIT background check within the last 4 years.'),
            ('non_mit_recent_check', 'I am not an MIT affiliate, but I had a valid MIT background check within the last year.'),
            ('mit_no_check', 'I am a current MIT affiliate and will make sure to get an MIT background check after registering my classes.'),
            ('non_mit_no_check', 'I am not an MIT affiliate and will make sure to get an MIT background check after registering my classes.'),
        ]),
        'category': 'teach',
        'is_setting': True,
        'field': JSONValidatedCharField(),
    },
    'minors_backgroundcheck_label': {
        'is_boolean': False,
        'help_text': 'Help text shown under the background-check question on the MIT Minors Policy acknowledgement form.',
        'default': 'The MIT Minors Policy requires that all teachers receive an MIT background check<b> regardless of MIT affiliation</b>. Background checks for MIT affiliates are valid for four years, and those for non-affiliates are valid for one year.',
        'category': 'teach',
        'is_setting': True,
    },
    'minors_observing_choices': {
        'is_boolean': False,
    ...
    'minors_observing_label': {
        'is_boolean': False,
        'help_text': 'Help text shown under the coteaching/observing question on the MIT Minors Policy acknowledgement form.',
        'default': 'The MIT Minors Policy requires that all classes have at least 2 adults present at all times.',
        'category': 'teach',
        'is_setting': True,
    },
