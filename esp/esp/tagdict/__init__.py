...
all_program_tags = {
    ...
    'teacherreg_hide_fields_open': (False, 'A comma seperated list of what fields (e.g. \'purchase_requests\') you want to hide from teachers during teacher open-class registration', None, 'teach', True),
