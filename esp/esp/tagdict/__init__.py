...
all_program_tags = {
    ...
    'cc_redirect': (False, "After credit card payment, to which page should we direct students? May be relative to the program URL (e.g. confirmreg, studentreg, etc.) or relative or full URLs may be used (e.g. https://www.google.com, /learn/thanks.html, etc.) (depricated)", "confirmreg", "learn", False), #depricated??
