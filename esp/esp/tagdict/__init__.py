...
all_global_tags = {
    ...
    'splashinfo_siblingdiscount': (False, ""),
    'splashinfo_lunchsat': (False, ""),
    'splashinfo_lunchsun': (False, ""),
    'use_class_size_optimal': (False, ""),
    ...
    'availability_group_timeslots': (False, "Group timeslots into contiguous blocks in the availability interface (enabled by default, set to 'False' to disable)"),
    'formstack_id': (False, ""),
    'formstack_viewkey': (False, ""),
    'group_phone_number': (False, ""),
    'finaid_form_fields': (False, ""),
    'onsite_classlist_min_refresh': (False, ""),
    'studentschedule_show_empty_blocks': (False, ""),
    ...
    'request_student_phonenum': (False, ""),
...
all_program_tags = {
    ...
    'collapse_full_classes': (False, ""),
    'friendly_times_with_date': (False, ""),
    'grade_range_popup': (False, ""),
    'quiz_form_id': (False, ""),
