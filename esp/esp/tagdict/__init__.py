...
all_program_tags = {
    ...
    'multiweek_schedule': {
        'is_boolean': True,
        'help_text': 'Expand recurring/multi-date class sections into one row per meeting date on printable student LaTeX schedules (useful for multi-week programs).',
        'default': False,
        'category': 'learn',
        'is_setting': True,
    },
