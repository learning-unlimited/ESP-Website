...
all_global_tags = {
    ...
    'webapp_isstep': (True, "Should the student onsite webapp be shown as a step in student registration?", False, 'learn', True),
    'google_cloud_api_key': (False, "An API key for use with the Google Cloud Platform", False, 'manage', True),
}
...
all_program_tags = {
    ...
    'program_center': (False, "The geographic center for a program, following the form {lat: 37.427490, lng: -122.170267}", None, 'manage', True),
    'count_checked_in_only': (True, "Whether to use registered students or checked in students to determine if a class is full (for studentonsite)", False, 'onsite', True),
}
