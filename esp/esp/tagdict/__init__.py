...
all_global_tags = {
    ...
    'onsite_show_paid_field': {
        'is_boolean': True,
        'help_text': 'Should the onsite registration form include a "paid in full" checkbox?',
        'default': True,
        'category': 'onsite',
        'is_setting': True,
    },
    ...
    'student_profile_show_guardian_info': {
        'is_boolean': True,
        'help_text': 'Should the student profile form ask for parent/guardian contact information?',
        'default': True,
        'category': 'learn',
        'is_setting': True,
    },
...
all_program_tags = {
    ...
    'volunteer_label_comments': {
        'is_boolean': False,
        'help_text': 'If set, overrides the label for the comments field for the volunteer form',
        'default': None,
        'category': 'volunteer',
        'is_setting': True,
    },
    'volunteer_help_text_requests': {
        'is_boolean': False,
        'help_text': 'If set, overrides the help text for the timeslots field for the volunteer form',
        'default': None,
        'category': 'volunteer',
        'is_setting': True,
    },
    'volunteer_help_text_confirm': {
        'is_boolean': False,
        'help_text': 'If set, overrides the text of the confirmation checkbox for the volunteer form (plain text; the default red styling is kept)',
        'default': None,
        'category': 'volunteer',
        'is_setting': True,
    },
    ...
    'bigboard_graph_drop_beg': {
        'is_boolean': False,
        'help_text': 'How many of the earliest data points to drop from each big board registration graph series. Raise this to stop a handful of very early registrations from flattening the graph.',
        'default': '4',
        'category': 'manage',
        'is_setting': True,
        'field': forms.IntegerField(min_value=0),
    },
    'bigboard_graph_drop_end': {
        'is_boolean': False,
        'help_text': 'How many of the latest data points to drop from each big board registration graph series.',
        'default': '0',
        'category': 'manage',
        'is_setting': True,
        'field': forms.IntegerField(min_value=0),
    ...
    'bigboard_graph_min_points': {
        'is_boolean': False,
        'help_text': 'The minimum number of data points a series must have to be shown on the big board registration graph.',
        'default': '5',
        'category': 'manage',
        'is_setting': True,
        'field': forms.IntegerField(min_value=1),
