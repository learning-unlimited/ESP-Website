...
all_global_tags = {
    ...
    "nearly_full_threshold": {
        ...
        "field": forms.DecimalField(
            min_value=Decimal(0.00), max_value=Decimal(1.00), decimal_places=2
        ),
    },
    ...
    "qsd_display_date_author": {
        ...
        "field": forms.ChoiceField(
            choices=[
                ("Both", "Display author, date, and time"),
                ("Date", "Display the date and time but not the author"),
    ...
    "grade_increment_date": {
        ...
        "field": forms.DateField(
            widget=forms.SelectDateWidget(years=[datetime.date.today().year])
        ),
    },
...
all_program_tags = {
    ...
    "student_self_checkin": {
        ...
        "field": forms.ChoiceField(
            choices=[
                ("none", "None (disable student self checkin)"),
                ("open", "Students only need to access the self checkin page"),
                (
                    "code",
                    "Students must enter their unique code to check themselves in",
                ),
            ]
        ),
    },
