...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LineItemOptions'
        db.create_table('accounting_lineitemoptions', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('lineitem_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounting.LineItemType'])),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('amount_dec', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=9, decimal_places=2, blank=True)),
        ))
        db.send_create_signal('accounting', ['LineItemOptions'])


    def backwards(self, orm):
        # Deleting model 'LineItemOptions'
        db.delete_table('accounting_lineitemoptions')
