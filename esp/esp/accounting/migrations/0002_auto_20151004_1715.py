    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                to="accounting.LineItemType", on_delete=models.CASCADE
            ),
        ),
        migrations.AddField(
            ...
            name="request",
            field=esp.db.fields.AjaxForeignKey(
                to="program.FinancialAidRequest", on_delete=models.CASCADE
            ),
        ),
        migrations.AddField(
            model_name="account",
            name="program",
            field=models.ForeignKey(
                blank=True, to="program.Program", null=True, on_delete=models.CASCADE
            ),
        ),
