...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transfer.transaction_id'
        db.add_column('accounting_transfer', 'transaction_id',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=64, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transfer.transaction_id'
        db.delete_column('accounting_transfer', 'transaction_id')
