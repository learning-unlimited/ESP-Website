    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.PositiveIntegerField(
                blank=True,
                help_text="Enter an integer between 0 and 100 here to grant a certain percentage discount after the above dollar credit is applied.  0 means no additional discount, 100 means no payment required.",
                null=True,
            ),
        ),
    ]
