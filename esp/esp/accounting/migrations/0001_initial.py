    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DecimalField(
                        default=Decimal("0"),
                        help_text="The difference between incoming and outgoing transfers that have been executed so far against this account.",
                        max_digits=9,
                        decimal_places=2,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "amount_max_dec",
                    models.DecimalField(
                        help_text="Enter a number here to grant a dollar value of financial aid.  The grant will cover this amount or the full cost of the program, whichever is less.",
                        null=True,
                        max_digits=9,
                        decimal_places=2,
                        blank=True,
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        help_text="Enter an integer between 0 and 100 here to grant a certain percentage discount to the program after the above dollar credit is applied.  0 means no additional discount, 100 means no payment required.",
                        null=True,
                        blank=True,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "text",
                    models.TextField(help_text="A description of this line item."),
                ),
                (
                    "amount_dec",
                    models.DecimalField(
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        ...
                        max_length=64,
                        verbose_name="credit card processor transaction ID number",
                        blank=True,
                    ),
                ),
                ("timestamp", models.DateTimeField(auto_now=True)),
