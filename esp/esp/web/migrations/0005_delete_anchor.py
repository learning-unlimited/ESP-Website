...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'NavBarCategory.anchor'
        db.delete_column('web_navbarcategory', 'anchor_id')

    def backwards(self, orm):
        # Adding field 'NavBarCategory.anchor'
        db.add_column('web_navbarcategory', 'anchor',
