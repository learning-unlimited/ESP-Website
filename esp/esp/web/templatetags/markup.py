"""
Copied from Django 1.4 version of the django.contrib.markup app:
  https://github.com/django/django/blob/stable/1.4.x/django/contrib/markup/templatetags/markup.py
This app has been deprecated by Django due to security reasons.
...
is only entered by "trusted" users.
"""
