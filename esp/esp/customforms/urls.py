...
urlpatterns = [
    ...
    re_path(
        r"^/success/(?P<form_id>\d{1,6})/$", views.success, name="customforms_success"
    ),
    re_path(
        r"^/responses/(?P<form_id>\d{1,6})/$",
        views.viewResponse,
        name="customforms_responses",
    ),
    ...
    re_path(
        r"^/exceldata/(?P<form_id>\d{1,6})/$",
        views.getExcelData,
        name="customforms_excel_data",
    ),
    re_path(
        r"^/bulkdownloadfiles/?",
        views.bulkDownloadFiles,
        name="customforms_bulk_download",
    ),
]
