...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Form.success_message'
        db.add_column('customforms_form', 'success_message', self.gf('django.db.models.fields.CharField')(default='', max_length=500), keep_default=False)

        # Adding field 'Form.success_url'
        db.add_column('customforms_form', 'success_url', self.gf('django.db.models.fields.CharField')(default='', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Form.success_message'
        db.delete_column('customforms_form', 'success_message')

        # Deleting field 'Form.success_url'
        db.delete_column('customforms_form', 'success_url')
    ...
    models = {
        ...
        'customforms.form': {
            ...
            'perms': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200'}),
            'success_message': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '500'}),
            'success_url': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200'}),
