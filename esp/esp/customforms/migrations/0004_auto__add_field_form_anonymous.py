...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Form.anonymous'
        db.add_column('customforms_form', 'anonymous', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Form.anonymous'
        db.delete_column('customforms_form', 'anonymous')
