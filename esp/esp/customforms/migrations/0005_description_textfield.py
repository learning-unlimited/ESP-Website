...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Form.description'
        db.alter_column('customforms_form', 'description', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):
        
        # Changing field 'Form.description'
        db.alter_column('customforms_form', 'description', self.gf('django.db.models.fields.CharField')(max_length=140))
