...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Form.perms'
        db.add_column('customforms_form', 'perms', self.gf('django.db.models.fields.CharField')(default='', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Form.perms'
        db.delete_column('customforms_form', 'perms')
