...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Form.link_type'
        db.alter_column('customforms_form', 'link_type', self.gf('django.db.models.fields.CharField')(max_length=50))


    def backwards(self, orm):
        
        # Changing field 'Form.link_type'
        db.alter_column('customforms_form', 'link_type', self.gf('django.db.models.fields.CharField')(max_length=10))
