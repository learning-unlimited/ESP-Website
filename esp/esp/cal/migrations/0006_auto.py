...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field available_locations on 'Event'
        m2m_table_name = db.shorten_name('cal_event_available_locations')
    ...
    def backwards(self, orm):
        # Removing M2M table for field available_locations on 'Event'
        db.delete_table(db.shorten_name('cal_event_available_locations'))
